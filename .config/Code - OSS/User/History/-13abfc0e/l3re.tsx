      ...
      <table className="w-full h-full border-spacing-0 border-collapse table-auto">
        ...
        <tbody>
          <tr className="h-20 border-t border-solid border-[#d8dee9]">
            ...
            <td className="py-6 px-6 h-full grid grid-cols-2 gap-3 items-center justify-center">
              <button className="p-2 rounded-sm border-none flex items-center justify-center bg-[#d8dee9] hover:bg-[#ebcb8b]">
                <BiPencil />
              </button>
              <button className="p-2 rounded-sm border-none flex items-center justify-center bg-[#d8dee9] hover:bg-[#bf616a]">
                <BiTrash />
              </button>
            </td>
          </tr>
