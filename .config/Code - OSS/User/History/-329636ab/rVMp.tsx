      ...
      <div className="container mx-auto border-b">
        <div className="">
          ...
          <form className="py-2">
            ...
            <button
              type="submit"
              className="flex justify-center mx-auto w-3/6 bg-teal-700 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-green-500 hover:text-green-500"
            >
              Add{" "}
              <span className="px-1">
