...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <main className="bg-[#e5e9f0] px-10 md:px-20 lg:px-40 dark:bg-[#4c566a]">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            <h2 className="text-5xl py-2 text-[#81a1c1] font-medium md:text-6xl">
              Berthose Fin
            </h2>
            <h3 className="text-2xl py-2 md:text-3xl">Developer Web</h3>
            <p className="text-md py-5 leading-8 text-[#4c566a] md:text-xl max-w-lg mx-auto">
          ...
          <div className="relative mx-auto bg-gradient-to-b from-[#81a1c1] to-[#88c0d0] rounded-full w-80 h-80 mt-5 overflow-hidden md:h-96 md:w-96">
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-[#4c566a]">
              Sice the beginning of my journey as a freelance developer, I`ve
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-[#e5e9f0]">
              ...
              <p className="py-2">
                ...
                dolorum similique suscipit amet libero ratione. Quibusdam
                corporis dolores ex dolor obcaecati rem!
              </p>
