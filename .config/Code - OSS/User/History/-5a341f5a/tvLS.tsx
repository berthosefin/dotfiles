...
export default function Home() {
  return (
    <main className="bg-[#e5e9f0] px-10 md:px-20 lg:px-40">
      ...
      <section>
        ...
        <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
          <div className="basis-1/3 flex-1">
            <Image src={git} alt="git" width={400} height={400} className="round object-cover" />
          </div>
          <div className="basis-1/3 flex-1">
            <Image src={php} alt="php" width={400} height={400} className="round object-cover" />
          </div>
          <div className="basis-1/3 flex-1">
            <Image src={python} alt="python" width={400} height className="round object-cover"={400} />
          </div>
          <div className="basis-1/3 flex-1">
            <Image src={php} alt="php" width={400} height={400} className="round object-cover" />
          </div>
