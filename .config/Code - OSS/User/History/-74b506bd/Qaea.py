...
# CNAPS
def cnaps(salaire):
    return cnaps = int((salaire * 1)/100)   # Retenu par l'employeur


# CDS
def cds(salaire):
    return cds = int((salaire * 2)/100)   # Retenu par l'employeur


# OSTIE
def ostie(salaire):
    return ostie = int((salaire * 1)/100)   # Retenu par l'employeur


# SI
def si(salaire):
    return si = salaire - cnaps(salaire) - cds(salaire) - ostie(salaire)
