...
export default function UpdateUserForm({ formId, formData, setFormData }: any) {
  ...
  return (
    <form className="grid lg:grid-cols-2 w-4/6 gap-4" onSubmit={handleSubmit}>
      ...
      <button className="flex justify-center text-md w-2/6 bg-[#ebcb8b] text-[#e5e9f0] px-4 py-2 border rounded-md hover:bg-[#e5e9f0] hover:border-[#ebcb8b] hover:text-[#ebcb8b]">
        Update
        <span className="px-1">
          <BiBrush size={24} />
        </span>
