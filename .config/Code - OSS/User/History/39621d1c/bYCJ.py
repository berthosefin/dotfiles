...
immeuble3 = Immeuble("53 rue elios mandr", 2, 2)
immeuble5 = Immeuble("120 rue rand", 8, 4)

# 2 supermarché
supermarche1 = Supermarche("27 rue de la StT", 1, 12)
supermarche2 = Supermarche("119 rue rand", 4, 25)

# 1 banque
banque = Banque("53 rue elios mandr", 12, 25, "FBanque")