...
# Columns
table.column(1, width='ID')
table.column(2, width='NOM')
table.column(3, width='PRENOM')
table.column(4, width='AGE')
table.column(5, width='ADDRESSE')
table.column(6, width='TELEPHONE')
table.column(7, width='REMARQUE')