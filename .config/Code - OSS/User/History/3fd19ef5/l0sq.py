...
# ID
lbl_id = Label(root, text="N°", font=(Arial, 16, ), bg='#A3BE8C', fg='#D8DEE9')
lbl_id.place(x=0, y=100, width=200)
entry_id = Entry(root)
entry_id.place(x=200, y=100, width=160, height=30)
...
# Mark
lbl_phone = Label(root, text="Rémarque", font=(Arial, 16, ), bg='#A3BE8C', fg='#D8DEE9')
lbl_phone.place(x=0, y=400, width=200)
entry_phone = Entry(root)
entry_phone.place(x=200, y=400, width=200, height=30)
...
btn_edit = Button(root, text="Modifier", font=(Arial, 16), bg='#81A1C1', fg='#D8DEE9', command=add_patient)
btn_edit.place(x=270, y=450, width=200)

btn_remove = Button(root, text="Supprimer", font=(Arial, 16), bg='#81A1C1', fg='#D8DEE9', command=add_patient)
