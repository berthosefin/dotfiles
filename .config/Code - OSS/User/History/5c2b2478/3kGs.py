...
def register_student():
    ...
    con = mysql.connector(host='localhost', user='birkhoff', password='', database='students')
    curs = con.cursor()
...
def edit_student():
    ...
    con = mysql.connector.connect(host='localhost', user='birkhoff', password='', database='students')
    curs = con.cursor()
