...
gender = StringVar()
lbl_gender_m = Radiobutton(root, text="MASCULIN", value='M', variable=gender, indicatoron=0, font=('Arial', 12), bg='#4C566A', fg='#D8DEE9')
lbl_gender_m.place(x=250, y=300, width=150)
lbl_gender_f = Radiobutton(root, text="FEMININ", value='F', variable=gender, indicatoron=0, font=('Arial', 12), bg='#4C566A', fg='#D8DEE9')
lbl_gender_f.place(x=250, y=300, width=150)
entry_gender = Entry(root, font=('Arial', 12))
entry_gender.place(x=250, y=250, width=300)
