...
btn_delete.place(x=250, y=500, width=200)

btn_delete = Button(root, text="Modifier", font=('Arial', 16), bg='#81A1C1', fg='#D8DEE9', command=edit_student)
btn_delete.place(x=250, y=550, width=200)
