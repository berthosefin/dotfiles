...
# Button
btn_delete = Button(root, text="Supprimer", font=('Arial', 16), bg='#A3BE8C', fg='#D8DEE9', command=delete_student)
btn_delete.place(x=250, y=600, width=200)

btn_delete = Button(root, text="Supprimer", font=('Arial', 16), bg='#81A1C1', fg='#D8DEE9', command=delete_student)
btn_delete.place(x=250, y=600, width=200)
