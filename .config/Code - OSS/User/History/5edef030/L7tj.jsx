      ...
      <div className="Info">
        ...
        <div className="title">
          <Link href={"/"} className="text-3xl md:text-6xl">
            ...
            molestias laudantium minus accusamus dicta quam voluptatem hic.
            Accusantium dicta nam quis nulla aliquid impedit praesentium,
            officiis sunt. Laboriosam, eius.
          </Link>
        </div>
      </div>
    </div>
