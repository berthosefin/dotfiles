...
export default async function techGroup() {
  ...
  return (
    <div className="grid sm:grid-cols-1 md:grid-cols-3 lg:gri-cols-4 gap-5 p-5">
      {techGroup.map((group: string, id: number) => (
        <Link
          className="shadow-gray-500 bg-gray-300 rounded text-xl text-center py-10 font-bold hover:bg-blue-500 hover:text-white"
