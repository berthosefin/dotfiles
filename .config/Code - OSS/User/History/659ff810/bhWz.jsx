    ...
    <table className="min-w-full table-auto">
      <thead>
        <tr className="bg-[#4c566a]">
          ...
          <th className="px-16 py-2">
            <span className="text-[#4c566a]">Email</span>
          </th>
          <th className="px-16 py-2">
            <span className="text-[#4c566a]">Salary</span>
          </th>
          <th className="px-16 py-2">
            <span className="text-[#4c566a]">Birthday</span>
          </th>
          <th className="px-16 py-2">
            <span className="text-[#4c566a]">Status</span>
          </th>
          <th className="px-16 py-2">
            <span className="text-[#4c566a]">Action</span>
          </th>
        </tr>
      </thead>
